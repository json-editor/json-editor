...
if(f&&"checkbox"===f){var g=this.createUuid();return b.id=g,e=document.createElement("p"),e.appendChild(b),a&&(a.setAttribute("for",g),e.appendChild(a)),e}
// Anything else gets wrapped in divs.
// Not .input-field for select wrappers.
return e=this._super(a,b,c,d),f&&f.startsWith("select")||(e.className="input-field"),e},/**
     * Gets a header element.
     * 
     * @param {string|object} text The header text or element.
     */
getHeader:function(a){var b=document.createElement("h5");return"string"==typeof a?b.textContent=a:b.appendChild(a),b},/**
...
getSelectInput:function(a){var b=this._super(a);return b.className="browser-default",b},/**
     ...
     */
getTextareaInput:function(){var a=document.createElement("textarea");return a.style.marginBottom="5px",a.style.fontSize="1rem",a.style.fontFamily="monospace",a},/**
