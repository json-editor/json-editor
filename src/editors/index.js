...
export const editors = {
  ace, array, arrayChoices, arraySelect2, arraySelectize, autocomplete,
  base64, button, checkbox, choices, datetime, describedBy, enum: EnumEditor,
  hidden, info, integer, ip, jodit, multiple, multiselect, null: NullEditor,
  number, object, radio, sceditor, select, select2, selectize, signature,
  simplemde, starrating, string, table, upload, uuid, colorpicker
}
