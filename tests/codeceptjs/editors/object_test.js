...
Scenario('should hide properties with unfulfilled dependencies @dependencies', (I) => {
  I.amOnPage('object-with-dependencies.html')
  I.seeElement('[data-schemapath="root.answerA"]')
  I.dontSeeElement('[data-schemapath="root.answerB"]')
  I.selectOption('root[answerA]', 'B')
  I.seeElement('[data-schemapath="root.answerB"]')
  I.selectOption('root[answerA]', 'A')
  I.dontSeeElement('[data-schemapath="root.answerB"]')
  I.selectOption('root[answerA]', 'C')
  I.seeElement('[data-schemapath="root.answerB"]')
})
