...
Scenario('should override error messages if specified in schema options @core @errors', async (I) => {
  ...
  I.waitForText('CUSTOM: Value must be the constant value')
  I.waitForText('CUSTOM: Value must be at least 6 characters long')
  I.waitForText('CUSTOM: Value must be at most 6 characters long')
  I.waitForText('CUSTOM: Value must validate against at least one of the provided schemas')
  I.waitForText('CUSTOM: Value must validate against exactly one of the provided schemas. It currently validates against 0 of the schemas')
  I.waitForText('CUSTOM: Value must be one of the provided types')
  I.waitForText('CUSTOM: Value must not be one of the provided disallowed types')
  I.waitForText('CUSTOM: Value must not be of type string')
  I.waitForText('CUSTOM: Value must be of type integer')
  I.waitForText('CUSTOM: Value must not validate against the provided schema')
  I.waitForText('CUSTOM: Date must be greater than 1 January 1970')
  I.waitForText('CUSTOM: Value must match the pattern ^[a-zA-Z0-9_]+$')
  I.waitForText('CUSTOM: Value must be a multiple of 5')
  I.waitForText('CUSTOM: Value must be at least 5')
  I.waitForText('CUSTOM: Value must be greater than 5')
  I.waitForText('CUSTOM: Value must be less than 10')
  I.waitForText('CUSTOM: Value must be less than 15')
  I.waitForText('CUSTOM: Object must have at least 1 properties')
  I.waitForText('CUSTOM: Object must have at most 1 properties')
  I.waitForText('CUSTOM: Object is missing the required property \'name\'')
  I.waitForText('CUSTOM: Unsupported propertyName UNSOPPORTED')
  I.waitForText('CUSTOM: Property name fullname cannot match invalid pattern')
  I.waitForText('CUSTOM: Property name fullname cannot match invalid enum')
  I.waitForText('CUSTOM: Property name fullname cannot match invalid maxLength')
  I.waitForText('CUSTOM: Property name fullname exceeds maxLength')
  I.waitForText('CUSTOM: Property name pets does not match pattern')
  I.waitForText('CUSTOM: Property name $pets does not match pattern')
  I.waitForText('CUSTOM: Property name pets does not match the const value')
  I.waitForText('CUSTOM: Property name pets does not match any enum values')
  I.waitForText('CUSTOM: Array must have unique items')
})
