...
Scenario('should validate against oneOf schemas and display single oneOf and editors error messages @core @oneof', async (I) => {
  ...
  I.waitForText('Object is missing the required property \'p4\'', 5, '.alert-danger')
  I.waitForText('Value must validate against exactly one of the provided schemas. It currently validates against 0 of the schemas.', 5, '.alert-danger')
  I.waitForText('Object is missing the required property \'p1\'', 5, '.alert-danger')
  I.waitForText('Object is missing the required property \'p2\'', 5, '.alert-danger')
  I.waitForText('Property must be set.', 5, '[data-schemapath="root.p4"] .invalid-feedback')
  I.waitForText('Property must be set.', 5, '[data-schemapath="root.p5.p1"] .invalid-feedback')
  I.waitForText('Property must be set.', 5, '[data-schemapath="root.p5.p2"] .invalid-feedback')
  ...
  I.waitForText('Value must be at least 4 characters long.', 5, '[data-schemapath="root.p4"] .invalid-feedback')
  I.waitForText('Value must be at least 4 characters long.', 5, '[data-schemapath="root.p5.p1"] .invalid-feedback')
  I.waitForText('Value must be at least 4 characters long.', 5, '[data-schemapath="root.p5.p2"] .invalid-feedback')
...
Scenario('should validate against anyOf schemas and display single anyOf and editors error messages @core @anyof', async (I) => {
  ...
  I.waitForText('Object is missing the required property \'age\'', 5, '.alert-danger')
  I.waitForText('Property must be set.', 5, '[data-schemapath="root.age"] .invalid-feedback')
