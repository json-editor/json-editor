...
* `hasPlaceholderOption` - If set to true, a placeholder option will be added to the select editor input.
* `placeholderOptionText` - Text displayed in select placeholder option.
